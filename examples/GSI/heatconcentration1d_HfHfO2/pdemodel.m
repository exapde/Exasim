...
% mu = [L Twall T0 R kB k H0 mu0 C0 D0 H tc Dc DTHf CvHf DTHfO2 CvHfO2 heatflux];
L  = mu(1);
T0 = mu(3);
kB = mu(5);
D0 = mu(10);
...
CvHfO2 = mu(17);
betaT = mu(19);
Cv = CvHfO2 * Cl + (1-Cl) * CvHf;

k1 = k*H0/Cv; 
Tphysical = T * T0;
mup = mu0 + R * Tphysical * log(Cl); % J / mol
k2 = C0*k*mup/Cv;   % K / s
KT = betaT*tc*(k1 + k2)/T0; % dimensionless rate
