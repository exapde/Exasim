...
x_step1_in    = 1.7;     % first inset at the top
x_step2_in    = 2.7;     % second inset
x_mid_out     = 3.7;     % outward bulge at mid-height
x_lower_in    = 5.4;     % inset near the lower step
x_toe_land    = 7.0;     % toe landward x at mudline (where wall meets mud)
