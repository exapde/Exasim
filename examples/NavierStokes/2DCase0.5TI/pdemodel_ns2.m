...
function fb = fbouhdg(u, q, w, v, x, t, mu, eta, uhat, n, tau)
    ...
    f_wall = 0*u;
    f_wall(1) = u(1) - uhat(1); % extrapolate density
    f_wall(2) = 0.0  - uhat(2); % zero velocity
    f_wall(3) = 0.0  - uhat(3); % zero velocity           
    f_wall(4) = -uhat(4) +uhat(1)*TisoW;
