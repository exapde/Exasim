...
% UDG0_adapt = mat_res.UDG2{5};
% UH0_adapt  = getuhat(UDG0_adapt, mesh_adapt.f2t, master.perm, 4);
% a          = mat_res.ACG2{5};
% mesh_adapt.dgnodes(:,3,:) = a;

% [UDG,UH] = hdgsolve(master,mesh_adapt,pde_ns,UDG0_adapt,UH0_adapt,[]);
