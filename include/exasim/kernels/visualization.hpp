...
// Iterate the user method `m(out, x, uq, w, mu, uinf, t)` over all
                        ...
                        int /*ncx*/, int /*nco*/, int /*ncw*/)
{
    ...
    detail::vis_dispatch<M>(f, xdg, udg, wdg, param, t, ng, nc_runtime,
        ...
        [](double out[], const double x[], const double uq[], const double w[],
           const double mu[], const double uinf[], double tt) {
            M::vis_scalars(out, x, uq, w, mu, uinf, tt);
        });
}
                        ...
                        int /*ncx*/, int /*nco*/, int /*ncw*/)
{
    ...
    detail::vis_dispatch<M>(f, xdg, udg, wdg, param, t, ng, nc_runtime,
        ...
        [](double out[], const double x[], const double uq[], const double w[],
           const double mu[], const double uinf[], double tt) {
            M::vis_vectors(out, x, uq, w, mu, uinf, tt);
        });
}
                        ...
                        int /*ncx*/, int /*nco*/, int /*ncw*/)
{
    ...
    detail::vis_dispatch<M>(f, xdg, udg, wdg, param, t, ng, nc_runtime,
        ...
        [](double out[], const double x[], const double uq[], const double w[],
           const double mu[], const double uinf[], double tt) {
            M::vis_tensors(out, x, uq, w, mu, uinf, tt);
        });
}
