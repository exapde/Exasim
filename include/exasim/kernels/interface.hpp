...
// plus the trace `uhg`, normal `nlg`, and stabilization `tau`.
// libpdemodel.hpp does not provide HDG variants for these (interface
// fluxes are evaluated only at the value level).
                 ...
                 int /*nc*/, int /*ncu*/, int /*nd*/, int /*ncx*/, int /*nco*/, int /*ncw*/)
{
    ...
    Kokkos::parallel_for("exasim::fhat_kernel", ng, KOKKOS_LAMBDA(size_t i) {
        double x[nd], uq1[Nq], uq2[Nq], w1[ncw_buf], w2[ncw_buf];
        ...
        double f_local[ncu];
        M::fhat(f_local, x, uq1, uq2, w1, w2, uh, n, t_, param, /*uinf=*/nullptr, t);
                 ...
                 int /*nc*/, int /*ncu*/, int /*nd*/, int /*ncx*/, int /*nco*/, int /*ncw*/)
{
    ...
    Kokkos::parallel_for("exasim::uhat_kernel", ng, KOKKOS_LAMBDA(size_t i) {
        ...
        double f_local[ncu];
        M::uhat(f_local, x, uq1, uq2, w1, w2, uh, n, t_, param, /*uinf=*/nullptr, t);
        for (int k = 0; k < ncu; ++k) f[k * ng + i] = f_local[k];
    });
}
                 ...
                 int /*nc*/, int /*ncu*/, int /*nd*/, int /*ncx*/, int /*nco*/, int /*ncw*/)
{
    ...
    Kokkos::parallel_for("exasim::stab_kernel", ng, KOKKOS_LAMBDA(size_t i) {
        ...
        double f_local[ncu];
        M::stab(f_local, x, uq1, uq2, w1, w2, uh, n, t_, param, /*uinf=*/nullptr, t);
        for (int k = 0; k < ncu; ++k) f[k * ng + i] = f_local[k];
    });
}
