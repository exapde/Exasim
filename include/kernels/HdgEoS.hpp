...
static void HdgEoSTemplate(dstype* f, dstype* f_udg, dstype* f_wdg,
                           ...
                           const int ncw_runtime)
{
    ...
    Kokkos::parallel_for("HdgEoS", ng, KOKKOS_LAMBDA(const size_t i) {
        ...
        dstype eos_local[ncu];
        dstype eos_uq[ncu * nc];
...
{
    HdgEoSTemplate<PdeModel>(f, f_udg, f_wdg, xdg, udg, odg, wdg, uinf,
