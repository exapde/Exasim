function mesh = foilmesh3(porder)
...
% bndexpr = {'all(sqrt(sum(p.^2,2))<2 & p(:,1)<=1.0089304129)','true'};  
% mesh = mkmesh(mf,tf,porder,bndexpr,elemtype,nodetype);
% mesh.dgnodes = nf;
% 
...
%q3 = q2; q3(2) = q3(2)-0.97*H;
q4 = mf(end,:); q4(2) = -q4(2);%mf(end-nxu-nxl+2,:)
q3 = q4; q3(1) = q3(1)+W;
...
[p,t] = connectmesh(mwl,twl,mf,tf,1e-6); 
[p,t] = connectmesh(p,t,mwu,twu,1e-6); 
[p,t] = fixmesh(p,t);
dgphy = cat(3,nwl,nf);
