...
template <typename T> void cpuFixNormal1D(T *nlg, int *facecon, int na);
...
template <typename T> void cpuStgHomoTurb(T *up, T *xdg, T *stgdata, T *uc, T t, int M, int N, int nd);
template <typename T> void cpuStgHomoTurb(T *up, T *xdg, T *stgdata, T *ui, T *uc, T *c, T *param, T t, int M, int N, int nd);
template <typename T> void cpuStgHomoTurb2(T *up, T *xdg, T *stgdata, T *ui, T *uc, T *c, T *param, T t, int M, int N, int nd);
