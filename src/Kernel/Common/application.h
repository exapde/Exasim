...
#ifdef _MUTATIONPP
template <typename T> void opuFlux(T *f, T *pg, T *udg, T *odg, T *wdg, T *uinf, T *param, 
        T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, Mutation::Mixture *);
template <typename T> void opuSource(T *s, T *pg, T *udg, T *odg, T *wdg, T *uinf, T *param, 
        T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, Mutation::Mixture *);
template <typename T> void opuSourcew(T *s, T *pg, T *udg, T *odg, T *wdg, T *uinf, T *param, 
        T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, int nce, int npe, int ne, Mutation::Mixture *);
template <typename T> void opuTdfunc(T *s, T *pg, T *udg, T *odg, T *wdg, T *uinf, T *param, 
        T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, Mutation::Mixture *);
template <typename T> void opuFbou(T *fh, T *pg, T *udg, T *odg, T *wdg,  T *uhg, T *nl, 
        T *tau, T *uinf, T *param, T time, int modelnumber, int ib, int ng, int nc, int ncu, int nd, 
        int ncx, int nco, int ncw, Mutation::Mixture *);
template <typename T> void opuUbou(T *ub, T *pg, T *udg, T *odg, T *wdg, T *uhg, T *nl, 
        T *tau, T *uinf, T *param, T time, int modelnumber, int ib, int ng, int nc, int ncu, int nd, 
        int ncx, int nco, int ncw, Mutation::Mixture *);
template <typename T> void opuAvfield(T *avfield, T *xdg, T *udg, T *odg, T *wdg, T *uinf, 
        T *param, T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, int nce, int npe, int ne, Mutation::Mixture *);
template <typename T> void opuOutput(T *output, T *xdg, T *udg, T *odg, T *wdg, T *uinf, 
        T *param, T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, int nce, int npe, int ne, Mutation::Mixture *);
template <typename T> void opuFhat(T *fh, T *xg, T *udg1, T *udg2, T *odg1, T *odg2,
        T *wdg1, T *wdg2, T *uhg, T *nl, T *tau, T *uinf, T *param, T time, int modelnumber, 
        int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, Mutation::Mixture *);
template <typename T> void opuUhat(T *fh, T *xg, T *udg1, T *udg2, T *odg1, T *odg2,
        T *wdg1, T *wdg2, T *uhg, T *nl, T *tau, T *uinf, T *param, T time, int modelnumber, 
        int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, Mutation::Mixture *);
template <typename T> void opuStab(T *fh, T *xg, T *udg1, T *udg2, T *odg1, T *odg2,
        T *wdg1, T *wdg2, T *uhg, T *nl, T *tau, T *uinf, T *param, T time, int modelnumber, 
        int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, Mutation::Mixture *);
template <typename T> void opuInitu(T *udg, T *xdg, T *uinf, T *param, int modelnumber, int ng, int ncx, int nc, int npe, int ne, Mutation::Mixture *);
template <typename T> void opuInitq(T *udg, T *xdg, T *uinf, T *param, int modelnumber, int ng, int ncx, int nc, int npe, int ne, Mutation::Mixture *);
template <typename T> void opuInitudg(T *udg, T *xdg, T *uinf, T *param, int modelnumber, int ng, int ncx, int nc, int npe, int ne, Mutation::Mixture *);
template <typename T> void opuInitwdg(T *udg, T *xdg, T *uinf, T *param, int modelnumber, int ng, int ncx, int ncw, int npe, int ne, Mutation::Mixture *);
template <typename T> void opuInitodg(T *udg, T *xdg, T *uinf, T *param, int modelnumber, int ng, int ncx, int nco, int npe, int ne, Mutation::Mixture *);
#endif
...
//         T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw);
// template <typename T> void gpuStabEnzyme(T *f, T *df, T *xg, T *udg1, T *dudg1, T *udg2, T *dudg2, 
//         T *odg1, T *odg2,  T *wdg1, T *dwdg1, T *wdg2, T *dwdg2, T *uhg, T *duhg, T *nlg, T *tau, T *uinf, T *param, 
//         T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw);
#endif
#endif                
