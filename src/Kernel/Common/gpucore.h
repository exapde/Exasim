...
template <typename T> void gpuFixNormal1D(T *nlg, int *facecon, int na);
...
template <typename T> void gpuStgHomoTurb(T *up, T *xdg, T *stgdata, T *uc, T t, int M, int N, int nd);
