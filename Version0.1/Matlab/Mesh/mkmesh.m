...
[mesh.plocal,mesh.tlocal,mesh.plocfc,mesh.tlocfc,mesh.perm] = masternodes(mesh.porder,dim,elemtype,nodetype);

% generate DG nodes
%mesh.dgnodes = createnodes(mesh,fd,varargin);
mesh.dgnodes = createdgnodes(mesh.p,mesh.t,mesh.f,curvedboundary,curvedboundaryexpr,porder);
