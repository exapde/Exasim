function nocodeface2(filename::String)
...
tmp = "(T *f, T *xdg, T *udg1, T *udg2,  T *uhg, T *odg1, T *odg2,  T *wdg1, T *wdg2,  T *nlg, T *tau, T *uinf, T *param, T time, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw)\n";
