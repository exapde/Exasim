...
template <typename T> void opuShapJacDetNormal(T *fqg, T *shapgt, T *nlg, T *jac, int nga, int np, int nd, int ngf)
{
    int N = nga*np;
    int M = ngf*np;
    int P = M*nd; 
...
template <typename T> void opuShapJacInv(T *sg, T *shapegt, T *Xx, int nge, int nd, int npe, int ne)
{
    int M = nge*ne;
    int N = M*npe;
    int P = M*nd;
...
template void opuShapJacDetNormal(double*, double*, double*, double*, int, int, int, int);
...
template void opuShapJacInv(double*, double*, double*, int, int, int, int);
...
template void opuShapJacDetNormal(float*, float*, float*, float*, int, int, int, int);   
...
template void opuShapJacInv(float*, float*, float*, int, int, int, int);
