...
% %Fluid params
% pde.physicsparam = [gam Re Pr D Fr epsilon declinationSun expMu expKappa];
%                    % 1  2  3  4 5     6         7            8      9
% %Dimensional params
% pde.physicsparam = [pde.physicsparam R0 R1 T0 T1 v0 L rho Tbot tauA];
%                    %                 10 11 12 13 14 15 16  17   18
% %EUV Params
% pde.physicsparam = [pde.physicsparam Keuv M EUVeff PiRad Reff];
%                    %                  19 20  21     22    23
% %Model Params
% pde.physicsparam = [pde.physicsparam model];
%                    %                  24
