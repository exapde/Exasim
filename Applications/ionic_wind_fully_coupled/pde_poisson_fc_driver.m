...
pde.modelfile = "pdemodel_fc_poisson_WORKS";    % name of a file defining the PDE model
...
% pde.dt = 1.0e-3*ones(1,1);   % time step sizes
...
pde.visscalars = {'phi', 1};  % list of scalar fields for visualization
pde.visvectors = {"grad phi", [2 3]}; % list of vector fields for visualization
