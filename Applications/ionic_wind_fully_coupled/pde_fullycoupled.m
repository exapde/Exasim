...
pde.modelfile = "pdemodel1_coupled";    % name of a file defining the PDE model
...
pde.dt = 1.0e-3*ones(1,3);   % time step sizes
...
pde.visvectors = {"grad ne", [3 4], "grad phi", [5 6]}; % list of vector fields for visualization
