...
pde.modelfile = "pdemodel_fc_convection_only";    % name of a file defining the PDE model
...
pde.visscalars = {"ne", 1};  % list of scalar fields for visualization
pde.visvectors = {"grad ne", [2 3]}; % list of vector fields for visualization
