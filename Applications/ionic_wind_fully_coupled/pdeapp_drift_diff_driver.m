...
pde.modelfile = "pdemodel_dd";    % name of a file defining the PDE model
...
pde.dt = 1.0e-3*ones(1,10);   % time step sizes
...
mesh.boundarycondition = [2, 2, 1, 1, 1, 1, 1]; % Set boundary condition for each boundary
