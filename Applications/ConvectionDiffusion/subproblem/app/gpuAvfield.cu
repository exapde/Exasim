#include "gpuAvfield1.cu"
#include "gpuAvfield2.cu"
...
{
	if (modelnumber == 1)
		gpuAvfield1(f, xdg, udg, odg, wdg, uinf, param, time, modelnumber, ng, nc, ncu, nd, ncx, nco, ncw, nce, npe, ne);
	else if (modelnumber == 2)
		gpuAvfield2(f, xdg, udg, odg, wdg, uinf, param, time, modelnumber, ng, nc, ncu, nd, ncx, nco, ncw, nce, npe, ne);
}
