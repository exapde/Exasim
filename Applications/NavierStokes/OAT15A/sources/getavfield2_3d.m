function avField = getavfield2_3d(udg,odg,param,porder)
gam = param(1);
gam1 = gam - 1.0;
Minf = param(4);
rmin = param(5);
...
ShearRatio = div_v*div_v / (div_v*div_v + ...
                            S_xx*S_xx + S_yx*S_yx + S_zx*S_zx + ...
                            S_xy*S_xy + S_yy*S_yy + S_zy*S_zy + ...
                            S_xz*S_xz + S_yz*S_yz + S_zz*S_zz + 1.0e-16);
rx = rx*dr;
ry = ry*dr;
rz = rz*dr;
nx = rx;
...
avd = avd*avfix;
% shear viscosity
x = (bh/porder)*sqrt(S_xx*S_xx + S_yx*S_yx + S_zx*S_zx + ...
                     S_xy*S_xy + S_yy*S_yy + S_zy*S_zy + ...
