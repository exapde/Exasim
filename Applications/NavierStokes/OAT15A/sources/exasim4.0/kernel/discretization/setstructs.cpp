...
{               
    ...
    common.nc = app.ndims[5]; // number of compoments of (u, q, p)
    ...
    common.ndofp = common.npe*common.ncp*common.ne; // number of degrees of freedom of p
    ...
    common.AVflag = app.problem[11];    // Flag for artificial viscosity. 0: No artificial viscosity; 1: Homogeneous artificial viscosity (C. Nguyen's formulation); 2: Hypersonic homogeneous artificial viscosity (C. Nguyen's formulation)
    ...
    common.ntdepbc = app.nsize[9];
    //cout<<common.ntdepbc<<endl;
    common.tdepbc = copyarray(app.tdepbc,app.nsize[9]); // timestep sizes   
    //cout<<common.tdepbc[0]<<"  "<<common.tdepbc[1]<<endl;
    common.tdepbcuh = (Int*) malloc(common.nbf*sizeof(Int));
    common.tdepbcudg = (Int*) malloc(common.nbf*sizeof(Int));    
    ...
    if (common.mpiProcs>1) { // MPI
        ...
        common.ndofp1 = common.npe*common.ncp*common.ne1; // number of degrees of freedom of p
        ...
        common.ndofp1 = common.npe*common.ncp*common.ne; // number of degrees of freedom of p
        ...
        string filein, string fileout, Int mpiprocs, Int mpirank, Int ompthreads, Int omprank) 
{
    ...
    if (common.ncs>0) {
        ...
        sol.udgavg = (dstype*) malloc (sizeof (dstype)*common.npe*common.ncs*common.ne1);    
    }            
...
{        
    ...
    cudaTemplateMalloc(&dapp.tdepbc, app.nsize[9]);    
    ...
    CHECK( cudaMemcpy( dapp.tdepbc, app.tdepbc, app.nsize[9]*sizeof(Int), cudaMemcpyHostToDevice ) );      
...
//     CHECK_CUBLAS(cublasSetPointerMode(common.cublasHandle, CUBLAS_POINTER_MODE_DEVICE));    
    ...
    if (common.ncs>0) {
        ...
        cudaTemplateMalloc(&sol.udgavg, common.npe*common.ncs*common.ne1);       
    }          
