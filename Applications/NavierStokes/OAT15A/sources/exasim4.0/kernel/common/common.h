...
struct appstruct {              
    ...
    Int *tdepbc=NULL; // time-dependent boundary conditions
...
struct solstruct {       
    ...
    dstype *uhbou0=NULL;  // uhat on the boundary at the zero time stage
    dstype *uhbou1=NULL;  // uhat on the boundary at the first time stage
    dstype *uhbou2=NULL;  // uhat on the boundary at the second time stage
    dstype *udgbou0=NULL;  // udg on the boundary at the zero time stage
    dstype *udgbou1=NULL;  // udg on the boundary at the first time stage
    dstype *udgbou2=NULL;  // udg on the boundary at the second time stage
...
struct commonstruct {     
    ...
    Int nc; // number of compoments of (u, q, p)
    Int ncu;// number of compoments of (u)
    Int ncq;// number of compoments of (q)
    Int ncp;// number of compoments of (p)
    ...
    Int ndofp1; // number of degrees of freedom of p
