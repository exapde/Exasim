function gencppflux(flux,xdg,udg,odg,param,time,appname)

filename = ['opuFlux' appname '.cpp'];
%delete(filename);
...
str = ['template <typename T> void opuFlux' appname num2str(d) 'd(T *f, T *xdg, T *udg, T *odg, T *param, T time, int ng, int nc, int ncu, int nd, int ncx, int nco)'];
fprintf(gid, '%s\n', str); 
str = '{';
fprintf(gid, '%s\n', str);         
...
str = ['template <typename T> void opuFlux' appname '(T *f, T *xdg, T *udg, T *odg, T *param, T time, int ng, int nc, int ncu, int nd, int ncx, int nco)'];
fprintf(gid, '%s\n', str); 
str = '{';
fprintf(gid, '%s\n', str);         
str = 'if (nd == 1) {';
fprintf(gid, '\t%s\n', str);         
if ~isempty(flux{1})
str = ['opuFlux' appname num2str(1) 'd(f, xdg, udg, odg, param, time, ng, nc, ncu, nd, ncx, nco);'];
fprintf(gid, '\t\t%s\n', str);      
end
str = '}';
fprintf(gid, '\t%s\n', str);         
...
fprintf(gid, '\t%s\n', str);         
if ~isempty(flux{2})
str = ['opuFlux' appname num2str(2) 'd(f, xdg, udg, odg, param, time, ng, nc, ncu, nd, ncx, nco);'];
fprintf(gid, '\t\t%s\n', str);      
end
str = '}';
fprintf(gid, '\t%s\n', str);         
...
fprintf(gid, '\t%s\n', str);         
if ~isempty(flux{3})
str = ['opuFlux' appname num2str(3) 'd(f, xdg, udg, odg, param, time, ng, nc, ncu, nd, ncx, nco);'];
fprintf(gid, '\t\t%s\n', str);      
end
str = '}';
fprintf(gid, '\t%s\n', str);         
...
str = ['template void opuFlux' appname '(double *, double *, double *, double *, double *, double, int, int, int, int, int, int);'];
fprintf(gid, '%s\n', str);  
str = ['template void opuFlux' appname '(float *, float *, float *, float *, float *, float,  int, int, int, int, int, int);'];
fprintf(gid, '%s\n', str);  
fprintf(gid, '\n'); 
...
f = strrep(f, ['__global__  void gpuFlux' appname '(T'], ['void gpuFlux' appname '(T']);   
...
ind1 = strfind(f,['void gpuFlux' appname '(T']);
