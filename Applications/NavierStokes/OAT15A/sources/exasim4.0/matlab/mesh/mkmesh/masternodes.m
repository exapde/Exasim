...
switch dim
    case 1 % 1D        
        [plocal,tlocal,plocfc,tlocfc,permnode,permedge,permface] = nodes1d(porder,nodetype); 
    case 2 % 2D
        if elemtype==0     % tri        
            [plocal,tlocal,plocfc,tlocfc,permnode,permedge,permface] = trinodes2d(porder,nodetype);            
        elseif elemtype==1 % quad
            [plocal,tlocal,plocfc,tlocfc,permnode,permedge,permface] = quadnodes2d(porder,nodetype);         
        end        
    case 3 %3D
        if elemtype==0     % tet
            [plocal,tlocal,plocfc,tlocfc,permnode,permedge,permface] = tetnodes3d(porder,nodetype); 
