...
pde.dt = 0.01*ones(10,1);   % time step sizes
pde.visdt = pde.dt(1);         % visualization timestep size
pde.saveSolFreq = 1;          % solution is saved every 100 time steps
pde.soltime = 6000; % steps at which solution are collected
pde.timestepOffset = 6000;
...
[mesh.p,mesh.t] = sphere_cube(R0,R1,40,20);
