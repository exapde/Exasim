...
pde.modelfile = "pdemodel_visc_pb";    % name of a file defining the PDE model
...
eval('!cp ../app_visc_pb_regen/* .');
% eval('!cp ../app_visc_pb_regen/opuAvfield_noreg.cpp opuAvfield.cpp')
