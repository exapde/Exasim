...
function f = avfield(u, q, w, v, x, t, mu, eta)
    nspecies = 5;
    nd = 2;
    f = avfieldPhysical2d_Di(u, q, w, v, x, t, mu, eta, nspecies, nd);
end
...
function f = flux(u, q, w, v, x, t, mu, eta)
    ...
    fv = fluxviscousPb_Di(u, q, w, v, x, t, mu, eta, nspecies, nd);
    f = fi - fv;
end
...
function fv = fluxviscousPb_Di(u, q, w, v, x, t, mu, eta, nspecies, ndim)
