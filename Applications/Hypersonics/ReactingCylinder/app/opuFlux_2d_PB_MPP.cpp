template <typename T> void opuFlux(T* __restrict__ f, T* __restrict__ xdg, T* __restrict__ udg, T*__restrict__ odg, T*__restrict__ wdg, T*__restrict__ uinf, T*__restrict__ param, T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, Mutation::Mixture *mix)
{
	...
	for (int i = 0; i <ng; i++) {
		...
		T t183 = t142+t149;
		f[0*ng+i] = t170+t192+t53*t79*udg6;
		f[1*ng+i] = t171+t193+t54*t79*udg6;
		f[2*ng+i] = t172+t194+t55*t79*udg6;
		f[3*ng+i] = t173+t195+t56*t79*udg6;
		f[4*ng+i] = t174+t196+t57*t79*udg6;
		f[5*ng+i] = t182+t188+uinf1+t8*t79;
		f[6*ng+i] = t189;
		f[7*ng+i] = t106*udg6-uinf7*(t150+t53*(t80*uinf2*(t86-t110)+t80*uinf3*(t87-t111)+t80*uinf4*(t88-t112)+t80*uinf5*(t90-t113)+t80*uinf6*(t92-t114)))-uinf8*(t152+t54*(t80*uinf2*(t86-t110)+t80*uinf3*(t87-t111)+t80*uinf4*(t88-t112)+t80*uinf5*(t90-t113)+t80*uinf6*(t92-t114)))-uinf9*(t154+t55*(t80*uinf2*(t86-t110)+t80*uinf3*(t87-t111)+t80*uinf4*(t88-t112)+t80*uinf5*(t90-t113)+t80*uinf6*(t92-t114)))-uinf10*(t156+t56*(t80*uinf2*(t86-t110)+t80*uinf3*(t87-t111)+t80*uinf4*(t88-t112)+t80*uinf5*(t90-t113)+t80*uinf6*(t92-t114)))-uinf11*(t158+t57*(t80*uinf2*(t86-t110)+t80*uinf3*(t87-t111)+t80*uinf4*(t88-t112)+t80*uinf5*(t90-t113)+t80*uinf6*(t92-t114)))-t79*udg6*(odg1*(t148+t79*(t120-udg14))+t12*uinf12*(t145+t79*(t120-udg14)*2.0)*(2.0/3.0))+t79*t185*udg7+t2*t11*t12*(uinf19*(udg16+t78*(t80*udg6*(t120-udg14)+t80*udg7*(t121-udg15))-t107*t108)+t68*uinf14+t69*uinf15+t70*uinf16+t72*uinf17+t74*uinf18);
		f[8*ng+i] = t175+t197+t53*t79*udg7;
		f[9*ng+i] = t176+t198+t54*t79*udg7;
		f[10*ng+i] = t177+t199+t55*t79*udg7;
		f[11*ng+i] = t178+t200+t56*t79*udg7;
		f[12*ng+i] = t179+t201+t57*t79*udg7;
		f[13*ng+i] = t189;
		f[14*ng+i] = t182+t187+uinf1+t9*t79;
		f[15*ng+i] = t106*udg7-uinf7*(t160+t53*(t80*uinf2*(t89-t115)+t80*uinf3*(t91-t116)+t80*uinf4*(t93-t117)+t80*uinf5*(t94-t118)+t80*uinf6*(t95-t119)))-uinf8*(t162+t54*(t80*uinf2*(t89-t115)+t80*uinf3*(t91-t116)+t80*uinf4*(t93-t117)+t80*uinf5*(t94-t118)+t80*uinf6*(t95-t119)))-uinf9*(t164+t55*(t80*uinf2*(t89-t115)+t80*uinf3*(t91-t116)+t80*uinf4*(t93-t117)+t80*uinf5*(t94-t118)+t80*uinf6*(t95-t119)))-uinf10*(t166+t56*(t80*uinf2*(t89-t115)+t80*uinf3*(t91-t116)+t80*uinf4*(t93-t117)+t80*uinf5*(t94-t118)+t80*uinf6*(t95-t119)))-uinf11*(t168+t57*(t80*uinf2*(t89-t115)+t80*uinf3*(t91-t116)+t80*uinf4*(t93-t117)+t80*uinf5*(t94-t118)+t80*uinf6*(t95-t119)))-t79*udg7*(t186+odg1*(t148+t79*(t120-udg14)))+t79*t185*udg6+t2*t11*t12*(uinf19*(udg24+t78*(t80*udg6*(t122-udg22)+t80*udg7*(t123-udg23))-t107*t109)+t71*uinf14+t73*uinf15+t75*uinf16+t76*uinf17+t77*uinf18);
	}
}
