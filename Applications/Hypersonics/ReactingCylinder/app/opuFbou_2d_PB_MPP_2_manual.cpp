...
template <typename T> void opuFbou3(T *f, T *xdg, T *udg, T *odg, T *wdg, T *uhg, T *nlg, T *tau, T *uinf, T *param, T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, Mutation::Mixture *mix)
{
	...
	for (int i = 0; i <ng; i++) {
        ...
        Ustate[8]  = udg[8*ng+i];
        Ustate[9]  = udg[9*ng+i];
        Ustate[10] = udg[10*ng+i];
        Ustate[11] = udg[11*ng+i];
        Ustate[12] = udg[12*ng+i];
        Ustate[13] = udg[13*ng+i];
        Ustate[14] = udg[14*ng+i];
        Ustate[15] = udg[15*ng+i];
        Ustate[16] = udg[16*ng+i];
        Ustate[17] = udg[17*ng+i];
        Ustate[18] = udg[18*ng+i];
        Ustate[19] = udg[19*ng+i];
        Ustate[20] = udg[20*ng+i];
        Ustate[21] = udg[21*ng+i];
        Ustate[22] = udg[22*ng+i];
        Ustate[23] = udg[23*ng+i];
        ...
        Uwall[8]   = udg[8*ng+i];
        Uwall[9]   = udg[9*ng+i];
        Uwall[10]  = udg[10*ng+i];
        Uwall[11]  = udg[11*ng+i];
        Uwall[12]  = udg[12*ng+i];
        Uwall[13]  = udg[13*ng+i];
        Uwall[14]  = udg[14*ng+i];
        Uwall[15]  = udg[15*ng+i];
        Uwall[16]  = udg[16*ng+i];
        Uwall[17]  = udg[17*ng+i];
        Uwall[18]  = udg[18*ng+i];
        Uwall[19]  = udg[19*ng+i];
        Uwall[20]  = udg[20*ng+i];
        Uwall[21]  = udg[21*ng+i];
        Uwall[22]  = udg[22*ng+i];
        Uwall[23]  = udg[23*ng+i];
		...
		{
			fstate[ii] = 0.5 * (fstate[ii] + fwall[ii]);
		}
