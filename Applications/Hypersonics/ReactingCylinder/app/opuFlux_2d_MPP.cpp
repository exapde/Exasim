template <typename T> void opuFlux(T* __restrict__ f, T* __restrict__ xdg, T* __restrict__ udg, T*__restrict__ odg, T*__restrict__ wdg, T*__restrict__ uinf, T*__restrict__ param, T time, int modelnumber, int ng, int nc, int ncu, int nd, int ncx, int nco, int ncw, Mutation::Mixture *mix)
{
	...
	for (int i = 0; i <ng; i++) {
		...
		T t67 = t64*udg6*udg7;
		T t68 = t65+t66;
		f[0*ng+i] = odg1*t58*udg9+t48*t64*udg6;
		f[1*ng+i] = odg1*t59*udg10+t49*t64*udg6;
		f[2*ng+i] = odg1*t60*udg11+t50*t64*udg6;
		f[3*ng+i] = odg1*t61*udg12+t51*t64*udg6;
		f[4*ng+i] = odg1*t62*udg13+t52*t64*udg6;
		f[5*ng+i] = uinf1+odg1*udg14+t64*(udg6*udg6);
		f[6*ng+i] = t67+odg1*udg15;
		f[7*ng+i] = odg1*udg16+t68*udg6;
		f[8*ng+i] = odg1*t58*udg17+t48*t64*udg7;
		f[9*ng+i] = odg1*t59*udg18+t49*t64*udg7;
		f[10*ng+i] = odg1*t60*udg19+t50*t64*udg7;
		f[11*ng+i] = odg1*t61*udg20+t51*t64*udg7;
		f[12*ng+i] = odg1*t62*udg21+t52*t64*udg7;
		f[13*ng+i] = t67+odg1*udg22;
		f[14*ng+i] = uinf1+odg1*udg23+t64*(udg7*udg7);
		f[15*ng+i] = odg1*udg24+t68*udg7;
		...
		// T t37 = t34*udg6*udg7;
		// T t38 = t35+t36;
		// f[0*ng+i] = t28*t34*udg6+odg1*udg9*(t18+(t2*t3)/((udg1*udg1)*1.0E+24+1.0));
		// f[1*ng+i] = t29*t34*udg6+odg1*udg10*(t19+(t2*t4)/((udg2*udg2)*1.0E+24+1.0));
		// f[2*ng+i] = t30*t34*udg6+odg1*udg11*(t20+(t2*t5)/((udg3*udg3)*1.0E+24+1.0));
		// f[3*ng+i] = t31*t34*udg6+odg1*udg12*(t21+(t2*t6)/((udg4*udg4)*1.0E+24+1.0));
		// f[4*ng+i] = t32*t34*udg6+odg1*udg13*(t22+(t2*t7)/((udg5*udg5)*1.0E+24+1.0));
		// f[5*ng+i] = uinf1+odg1*udg14+t34*(udg6*udg6);
		// f[6*ng+i] = t37+odg1*udg15;
		// f[7*ng+i] = odg1*udg16+t38*udg6;
		// f[8*ng+i] = odg1*udg17*(t2*atan(udg17*1.0E+12)+(t2*udg17*1.0E+12)/((udg17*udg17)*1.0E+24+1.0)+1.0/2.0)+t28*t34*udg7;
		// f[9*ng+i] = odg1*udg18*(t2*atan(udg18*1.0E+12)+(t2*udg18*1.0E+12)/((udg18*udg18)*1.0E+24+1.0)+1.0/2.0)+t29*t34*udg7;
		// f[10*ng+i] = odg1*udg19*(t2*atan(udg19*1.0E+12)+(t2*udg19*1.0E+12)/((udg19*udg19)*1.0E+24+1.0)+1.0/2.0)+t30*t34*udg7;
		// f[11*ng+i] = odg1*udg20*(t2*atan(udg20*1.0E+12)+(t2*udg20*1.0E+12)/((udg20*udg20)*1.0E+24+1.0)+1.0/2.0)+t31*t34*udg7;
		// f[12*ng+i] = odg1*udg21*(t2*atan(udg21*1.0E+12)+(t2*udg21*1.0E+12)/((udg21*udg21)*1.0E+24+1.0)+1.0/2.0)+t32*t34*udg7;
		// f[13*ng+i] = t37+odg1*udg22;
		// f[14*ng+i] = uinf1+odg1*udg23+t34*(udg7*udg7);
		// f[15*ng+i] = odg1*udg24+t38*udg7;
		// T t2 = udg1*udg1;
		// T t3 = udg2*udg2;
		// T t4 = udg3*udg3;
		// T t5 = udg4*udg4;
