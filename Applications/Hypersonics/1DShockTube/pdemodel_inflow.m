...
%     end
    u0(1) = smoothstep_up(x, rho_post(1), rho_pre(1), 1/100);
    ...
    u0(nspecies+1) = smoothstep_down(x, rhou_post, rhou_pre, 1/100);
    u0(nspecies+2) = smoothstep_down(x, rhoE_post, rhoE_pre, 1/100);
