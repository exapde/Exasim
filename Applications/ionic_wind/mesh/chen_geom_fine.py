...
gmsh.model.mesh.field.setString(13, "F", "20*(F4/{})^1.5 + .0001".format(ref_len))

gmsh.model.mesh.field.add("MathEval", 12)
gmsh.model.mesh.field.setString(12, "F", "10*(F3/{})^2 + .0003".format(ref_len))

gmsh.model.mesh.field.add("MathEval", 11)
gmsh.model.mesh.field.setString(11, "F", "10*(F2/{})^2 + .0007".format(ref_len))

gmsh.model.mesh.field.add("MathEval", 10)
gmsh.model.mesh.field.setString(10, "F", "10*(F1/{})^2 + .0007".format(ref_len))
...
gm.mesh.generate(2)
gmsh.write('chen_geom_fine.msh3')
gmsh.fltk.run()
exit()
