...
namespace te_builtins
    ...
    [[nodiscard]]
    static te_type te_equal(te_type val1, te_type val2) noexcept
        {
    ...
    [[nodiscard]]
    static te_type te_not_equal(te_type val1, te_type val2) noexcept
        {
        return (!std::isfinite(val1) || !std::isfinite(val2)) ?
                   te_parser::te_nan :
                   static_cast<te_type>((val1 != val2) ? 1 : 0);
    ...
    [[nodiscard]]
    static te_type te_less_than(te_type val1, te_type val2) noexcept
        {
        return (!std::isfinite(val1) || !std::isfinite(val2)) ?
                   te_parser::te_nan :
                   static_cast<te_type>((val1 < val2) ? 1 : 0);
    ...
    [[nodiscard]]
    static te_type te_less_than_equal_to(te_type val1, te_type val2) noexcept
        {
        return (!std::isfinite(val1) || !std::isfinite(val2)) ?
                   te_parser::te_nan :
                   static_cast<te_type>((val1 <= val2) ? 1 : 0);
    ...
    [[nodiscard]]
    static te_type te_greater_than(te_type val1, te_type val2) noexcept
        {
        return (!std::isfinite(val1) || !std::isfinite(val2)) ?
                   te_parser::te_nan :
                   static_cast<te_type>((val1 > val2) ? 1 : 0);
    ...
    [[nodiscard]]
    static te_type te_greater_than_equal_to(te_type val1, te_type val2) noexcept
        {
        return (!std::isfinite(val1) || !std::isfinite(val2)) ?
                   te_parser::te_nan :
                   static_cast<te_type>((val1 >= val2) ? 1 : 0);
    ...
    [[nodiscard]]
    static te_type te_and(te_type val1, te_type val2)
        {
        // clang-format off
        return (!std::isfinite(val1) && !std::isfinite(val2)) ?
            te_parser::te_nan :
    ...
    [[nodiscard]]
    static te_type te_or(te_type val1, te_type val2)
        {
        // clang-format off
        return (!std::isfinite(val1) && !std::isfinite(val2)) ?
            te_parser::te_nan :
