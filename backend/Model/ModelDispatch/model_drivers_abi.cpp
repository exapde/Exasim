 ...
 * @brief Core-side driver wrappers built on top of DriverABI.
 *
...
void FluxDriver(dstype* f, const dstype* xg, const dstype* udg,
                const dstype* odg, const dstype* wdg, const DriverABI& abi,
...
void MonitorDriver(dstype* f, Int nc_sol, const dstype* xg,
                   ...
                   const DriverABI& abi, meshstruct& mesh,
...
void FhatDriver(dstype* fg, const dstype* xg, const dstype* ug1,
                ...
                const dstype* nl, const DriverABI& abi, meshstruct& mesh,
                masterstruct& master, appstruct& app, solstruct& sol,
...
void UhatDriver(dstype* fg, dstype* xg, dstype* ug1, dstype* ug2,
                ...
                const DriverABI& abi, meshstruct& mesh, masterstruct& master,
...
void InitodgDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                   appstruct& app, Int ncx, Int nco, Int npe, Int ne,
                   Int backend)
{
    Int numPoints = npe * ne;
...
void InitqDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                 appstruct& app, Int ncx, Int nc, Int npe, Int ne,
                 Int backend)
{
    Int numPoints = npe * ne;
    Int modelnumber = app.flag[12];
...
void InitudgDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                   appstruct& app, Int ncx, Int nc, Int npe, Int ne,
                   Int backend)
{
    Int numPoints = npe * ne;
...
void InituDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                 appstruct& app, Int ncx, Int nc, Int npe, Int ne,
                 Int backend)
{
    Int numPoints = npe * ne;
...
void InitwdgDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                   appstruct& app, Int ncx, Int ncw, Int npe, Int ne,
                   Int backend)
{
    Int numPoints = npe * ne;
    Int modelnumber = app.flag[12];
...
void cpuInitodgDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                      appstruct& app, Int ncx, Int nco, Int npe, Int ne,
                      Int backend)
{
    Int numPoints = npe * ne;
...
void cpuInitqDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                    appstruct& app, Int ncx, Int nc, Int npe, Int ne,
                    Int backend)
{
    Int numPoints = npe * ne;
...
void cpuInitudgDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                      appstruct& app, Int ncx, Int nc, Int npe, Int ne,
                      Int backend)
{
    Int numPoints = npe * ne;
...
void cpuInituDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                    appstruct& app, Int ncx, Int nc, Int npe, Int ne,
                    Int backend)
{
    Int numPoints = npe * ne;
...
void cpuInitwdgDriver(dstype* f, const dstype* xg, const DriverABI& abi,
                      appstruct& app, Int ncx, Int ncw, Int npe, Int ne,
                      Int backend)
{
    Int numPoints = npe * ne;
...
void SourceDriver(dstype* f, dstype* f_udg, dstype* f_wdg,
                  ...
                  const dstype* wdg, const DriverABI& abi, meshstruct& mesh,
                  masterstruct& master, appstruct& app, solstruct& sol,
...
void FextDriver(dstype* f, dstype* f_udg, dstype* f_wdg, dstype* f_uhg,
                dstype* xg, const dstype* udg, const dstype* odg,
                const dstype* wdg, dstype* uhg, const dstype* nl,
                const dstype* uext, const DriverABI& abi, meshstruct& mesh,
                masterstruct& master, appstruct& app, solstruct& sol,
                tempstruct& temp, commonstruct& common, Int nga, Int ib,
                Int backend)
{
...
void FextDriver(dstype* f, dstype* xg, const dstype* udg,
                const dstype* odg, const dstype* wdg, dstype* uhg,
                const dstype* nl, const dstype* uext, const DriverABI& abi,
                meshstruct& mesh, masterstruct& master, appstruct& app,
                solstruct& sol, tempstruct& temp, commonstruct& common,
...
void FhatDriver(dstype* f, dstype* u, const dstype* xg, dstype* udg,
                const dstype* odg, const dstype* wdg, const dstype* uhg,
                dstype* nl, const DriverABI& abi, meshstruct& mesh,
                masterstruct& master, appstruct& app, solstruct& sol,
