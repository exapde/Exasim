#include "KokkosFlux1.cpp"
#include "KokkosFlux2.cpp"
...
{
	if (modelnumber == 1)
		KokkosFlux1(f, xdg, udg, odg, wdg, uinf, param, time, modelnumber, ng, nc, ncu, nd, ncx, nco, ncw);
	else if (modelnumber == 2)
		KokkosFlux2(f, xdg, udg, odg, wdg, uinf, param, time, modelnumber, ng, nc, ncu, nd, ncx, nco, ncw);
}
