...
static void KokkosQoIvolumeTemplate(dstype* f, const dstype* xdg,
                                    ...
                                    const int ncw_runtime)
{
    ...
    Kokkos::parallel_for("QoIvolume", ng, KOKKOS_LAMBDA(const size_t i) {
        ...
        Model::qoi_volume(out_local, x, uq, v, w, param, uinf, time);
...
{
    KokkosQoIvolumeTemplate<PdeModel>(f, xdg, udg, odg, wdg, uinf, param, time,
