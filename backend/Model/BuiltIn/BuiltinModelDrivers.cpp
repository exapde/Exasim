...
{ 
  ...
  KokkosSourcew(f, xg, udg, odg, wdg, app.uinf, app.physicsparam, time, common.builtinmodelID,
...
{ 
  ...
  KokkosAvfield(f, xg, udg, odg, wdg, app.uinf, app.physicsparam, time, common.builtinmodelID, 
...
{ 
  ...
  KokkosEoS(f, xg, udg, odg, wdg, app.uinf, app.physicsparam, time, common.builtinmodelID,
              numPoints, nc, ncu, nd, ncx, nco, ncw, ncw, npe, ne);                                          
}
...
{ 
  ...
  KokkosEoSdu(f, xg, udg, odg, wdg, app.uinf, app.physicsparam, time, common.builtinmodelID,
...
{ 
  ...
  KokkosEoSdw(f, xg, udg, odg, wdg, app.uinf, app.physicsparam, time, common.builtinmodelID,
...
{     
  ...
  KokkosInitodg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nco, npe, ne);                
}
...
{     
  ...
  KokkosInitq(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
...
{     
  ...
  KokkosInitudg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
}
...
{     
  ...
  KokkosInitu(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
}
...
{     
  ...
  KokkosInitwdg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, ncw, npe, ne);                
}
...
{     
  ...
  cpuInitodg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nco, npe, ne);                
}
...
{     
  ...
  cpuInitq(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
...
{     
  ...
  cpuInitudg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
}
...
{     
  ...
  cpuInitu(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
}
...
{     
  ...
  cpuInitwdg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, ncw, npe, ne);                
}
