 ...
 * GetDriverABI(). It intentionally avoids backend-facing driver wrappers and
 * therefore stays independent of mesh/master/sol/temp/common runtime state.
 */

#include "../ModelDispatch/driver_abi.hpp"

namespace exasim::frontend_generated_source {
...
const DriverABI& getFrontendGeneratedDriverABI()
{
