#include "KokkosEoSdu1.cpp"
#include "KokkosEoSdu2.cpp"
...
{
	if (modelnumber == 1)
		KokkosEoSdu1(f, xdg, udg, odg, wdg, uinf, param, time, modelnumber, ng, nc, ncu, nd, ncx, nco, ncw, nce, npe, ne);
	else if (modelnumber == 2)
		KokkosEoSdu2(f, xdg, udg, odg, wdg, uinf, param, time, modelnumber, ng, nc, ncu, nd, ncx, nco, ncw, nce, npe, ne);
}
