/*
  ...
  1. void wEquation(dstype *wdg, dstype *xdg, dstype *udg, dstype *odg, dstype *wsrc, dstype *tempg, appstruct &app, ExasimDriverABI& driver_abi, commonstruct &common, Int ng, Int backend)
  ...
  2. void wEquation(dstype *wdg, dstype *wdg_udg, dstype *xdg, dstype *udg, dstype *odg, dstype *wsrc, dstype *tempg, appstruct &app, ExasimDriverABI& driver_abi, commonstruct &common, Int ng, Int backend)
  ...
  3. void GetW(dstype *w, solstruct &sol, tempstruct &tmp, appstruct &app, ExasimDriverABI& driver_abi, commonstruct &common, Int backend)
...
void wEquation(dstype *wdg, dstype *xdg, dstype *udg, dstype *odg, dstype *wsrc,
      dstype *tempg, appstruct &app, ExasimDriverABI& driver_abi, commonstruct &common, Int ng, Int backend)
{
    ...
    if (common.wave==1) {
        ...
        for (int iter=0; iter<20; iter++) {
          ...
          driver_abi.HdgSourcewonly(s, s_wdg, xdg, udg, odg, wdg, uinf, physicsparam, time, modelnumber, ng, nc, ncu, nd, ncx, nco, ncw);
          // if (backend <= 1) {
    ...
    if (common.wave==1) {
        ...
        for (int iter=0; iter<20; iter++) {
          ...
          if (nrm < 1e-8) {
            ...
            driver_abi.HdgSourcew(s, wdg_udg, s_wdg, xdg, udg, odg, wdg, uinf, physicsparam, time, modelnumber, ng, nc, ncu, nd, ncx, nco, ncw);
...
void GetW(dstype *w, solstruct &sol, tempstruct &tmp, appstruct &app, ExasimDriverABI& driver_abi, commonstruct &common, Int backend)
{
