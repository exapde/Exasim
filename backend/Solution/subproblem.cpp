...
void Residual(dstype* Ru, dstype* u, CDiscretization& disc, Int backend)
{
    ...
    ArrayInsert(disc.sol.udg, u, disc.common.npe, disc.common.nc, disc.common.ne, 0, disc.common.npe, 
            0, disc.common.ncu, 0, disc.common.ne1);  
    ...
    ArrayCopy(Ru, disc.res.Ru, disc.common.ndof1);          
}
...
{            
    ...
    if (oldnrm < disc.common.nonlinearSolverTol) {
      ArraySetValue(sys.x, zero, disc.common.ndof1);
      return 1;           
    }
...
//         cout<<"Newton Iteration: "<<it<<",  Solution Norm: "<<nrmr<<endl;                                                    
    ...
    for (it=1; it<maxit; it++) {                        
        ...
        ArrayAXPBY(sys.u, sys.u, sys.x, one, one, N); 
...
{  
    if (common.subproblem==1) {        
        ...
        for (int n=0; n<ncw; n++) {            
            ...
            ArrayExtract(subprob->disc.res.Ru, sol.udg, npe, common.nc, ne, 0, npe, k, k+1, 0, ne);         
            ArrayInsert(subprob->disc.sol.wdg, subprob->disc.res.Ru, npe, ncw, ne, 0, npe, n, n+1, 0, ne);          
        }                
        ...
        for (int n=0; n<ncw; n++) {            
            ...
            ArrayExtract(res.Ru, subprob->disc.sol.udg, npe, subprob->disc.common.nc, ne, 0, npe, k, k+1, 0, ne);         
            ArrayInsert(sol.wdg, res.Ru, npe, ncw, ne, 0, npe, n, n+1, 0, ne);          
        }                
    }
