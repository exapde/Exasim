function [k, sol] = readsolmpi(base, nprocs, nsteps, stepoffsets)

if nprocs == 1
    [n1, n2, n3, timesteps, sol] = readsol(base, nsteps, stepoffsets);
    k = [n1, n2, n3, timesteps];
    return;
end
...
if nargout > 1 
    ...
    for n = 1:nproc
        ...
        for i = 1:nsteps
            ...
            sol(:,:,(mn+1:mn+n3),i) = reshape(tm, [n1, n2, n3]);
        end
        mn = mn + n3;
