...
[master.plocvl,master.tlocvl,master.plocfc,master.tlocfc,permnode,permedge,permface] = mkmasternodes(porder,dim,elemtype,nodetype);
if dim==1
...
[master.plocmv,master.tlocmv,master.plocmf,master.tlocmf,permnode,permedge,permface] = mkmasternodes(morder,dim,elemtype,nodetype);
if dim==1
