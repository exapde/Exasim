function m = bnd_gt(p, param)
%BND_GT Coordinate greater-than predicate.
%   m = bnd_gt(p, param), param = [axis, value] or [axis, value, tol]
%   Also supports struct with fields axis, value, optional tol.

[axis, value, tol] = parseAxisParam(p, param, "bnd_gt");
m = p(axis,:) > value - tol;
end
