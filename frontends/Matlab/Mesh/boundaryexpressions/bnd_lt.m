function m = bnd_lt(p, param)
%BND_LT Coordinate less-than predicate.
%   m = bnd_lt(p, param), param = [axis, value] or [axis, value, tol]
%   Also supports struct with fields axis, value, optional tol.

[axis, value, tol] = parseAxisParam(p, param, "bnd_lt");
m = p(axis,:) < value + tol;
end
