function m = bnd_ge(p, param)
%BND_GE Coordinate greater-than-or-equal predicate.
%   m = bnd_ge(p, param), param = [axis, value] or [axis, value, tol]
%   Also supports struct with fields axis, value, optional tol.

[axis, value, tol] = parseAxisParam(p, param, "bnd_ge");
m = p(axis,:) >= value - tol;
end
