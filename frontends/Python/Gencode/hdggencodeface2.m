function strkk = hdggencodeface2(filename, f, xdg, udg, odg, wdg, uhg, nlg, tau, uinf, param, time, foldername)
...
function strkk = hdggencodebou2(filename, f, xdg, udg, odg, wdg, uhg, nlg, tau, uinf, param, time)
