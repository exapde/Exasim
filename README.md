...
After downloading the Exasim source code, you can try many examples in Exasim/Applications by running a script pdeapp.jl in Julia, pdeapp.py in Python, or pdeapp.m in Matlab. 
